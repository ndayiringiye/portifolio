  ...
  return (
    ...
    <div className="bg-blue-300 mt-24">
      <div className="flex justify-end gap-4 py-6 px-4 shadow-md">
        ...
        <Link to="https://www.instagram.com/" className="bg-white p-2 text-center rounded-full text-indigo-300 text-violete-400 text-purple-950"><FaInstagramSquare /></Link>
      ...
      <div>
         <div className="grid grid-cols-3 gap-x-6 w-11/12 mx-auto py-10 shadow-md">
